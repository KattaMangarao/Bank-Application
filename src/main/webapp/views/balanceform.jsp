    ...
    <body>
        ...
        <button><a href="/aboutus">AboutUs</a></button>
            ...
            <div class="form">
                <form action="/bal">
                    <table>
                    <h2 style="background-color: bisque;border-radius: 10px;width: 30%;">BALANCE FORM</h2>
                ...
                <tr><td><input type="submit" value="GetBalance"></td>
                </tr>
        ...
        <div class="sevice">
           <center> <h2 style="border: 1px solid black;background-color:bisque;border-radius: 10px;width:100%;">SERVICES</h2></center>
            ...
            <div class="welcome">
                ...
                <div class="logo">
                    <img src="file:///C:/Users/personal/Desktop/images/sdfcbanklogo.png">
                </div>
    </body>
</html>