    ...
    <body>
        ...
        <button><a href="/aboutus">AboutUs</a></button>
            ...
            <div class="form">
                <form action="/close">
                    <table>
                    <h2 style="border:1px solid black;background-color: bisque;border-radius: 10px;width: 30%;">CLOSE ACCOUNT</h2>
               ...
               <tr><td><center><input type="submit" value="CloseAccount"></center></td></tr>
