    ...
    <body>
        ...
        <button><a href="/aboutus">AboutUs</a></button>
            ...
            <div class="form">
                <form action="/depo">
                    <table>
                    <h2 style="background-color: bisque;border-radius: 10px;width: 30%;">DEPOSIT FORM</h2>
                ...
                <tr><td>DEPOSIT AMOUNT:</td><td><input type="number" name="balance" placeholder="deposit amount" required="required" ></td></tr>
                 <tr><td><center><input type="submit" value="Deposit"></center></td></tr>
