    ...
    <body>
        ...
        <button><a href="/aboutus">AboutUs</a></button>
            ...
            <div class="form">
                <form action="/withd">
                    <table>
                    <h2 style="background-color: bisque;border-radius: 10px;width: 30%;">WITHDRAW FORM</h2>
                ...
                <tr><td>WITHDRAW AMOUNT:</td><td><input type="number" name="balance" placeholder="withdraw amount" required="required" ></td></tr>
                 <tr><td><center><input type="submit" value="Withdraw"></center></td></tr>
