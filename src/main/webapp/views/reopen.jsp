    ...
    <body>
        ...
        <button><a href="/aboutus">AboutUs</a></button>
            ...
            <div class="form">
                <form action="/ropen">
                    <table>
                    <h2 style="border:1px solid black;background-color: bisque;border-radius: 10px;width: 30%;">REOPEN ACCOUNT</h2>
                   
                <tr><td>ACCOUNT NUMBER:</td><td><input type="text"  name="accountno" required="required" placeholder="closing account number"></td></tr>
               ...
               <tr><td><center><input type="submit" value="ReOpenAccount"></center></td></tr>
